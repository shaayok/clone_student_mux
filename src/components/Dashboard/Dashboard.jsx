...
export default function Dashboard() {
    ...
    (async () => {
      try {
        ...
        if (Array.isArray(all) && all.length > 0) {
          ...
          const demoLesson = demoVideoObject.map(o => ({
            ...o,
            date: new Date(o.date),
            start: new Date(o.start),
            end: new Date(o.end),
            videos: demoVideoListObject.length            
          }));
          setLessons(demoLesson);
          setDataType('demo');
        }
      } catch (err) {
  ...
  const demoVideosForLesson = useMemo(() => demoVideoListObject, []);
            ...
            <main className={styles.main}>
              {/* <VideoPanel selectedLesson={selectedLesson} dataType={dataType} demoVideoListObject={demoVideoListObject} /> */}
                ...
                <VideoPanel
                  ...
                  isDemo={dataType === 'demo'}
                  demoVideos={demoVideosForLesson}
                />
              )}
            </main>
          </div>
